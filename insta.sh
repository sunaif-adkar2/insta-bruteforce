#!/bin/bash
# FB by: https://youtube.com/channel/UCO2HqhBLZ6G0c_8KAsSQuFA
...
printf "\e[1;92m _  | | please use for education purpose    \e[0m\n"
printf "\e[1;92m( \ | | ____    ___  _| |_  _____           \e[0m\n"
printf "\e[1;92m ) )| ||  _ \  /___)(_   _)(____ | sunaif   \e[0m\n"
printf "\e[1;77m(_/ | || | | ||___ |  | |_ / ___ |  _____   \e[0m\n"
printf "\e[1;77m    |_||_| |_|(___/    \__)\_____| (_____)  \e[0m\n"
printf "\n"
printf "\e[1;77m\e[45m   Instagram Brute Forcer v1.01 Author: sunaif-adkar (Github/IG)   \e[0m\n"
printf "\n"
}
